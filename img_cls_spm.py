...
grid_spacing=8
pyramid_level=2
print("Extracting SPM feature for training images")
feat_train=feat_coding.get_spm_feat(train_img_list,grid_spacing,patch_size,bow_model,pyramid_level)
...
for kk in range(num_batch):
    ...
    feat_test=feat_coding.get_spm_feat(img_batch,grid_spacing,patch_size,bow_model,pyramid_level)
