...
feat_train=feat_coding.get_vlad_feat(train_img_list,grid_spacing,patch_size,bow_model)
...
for kk in range(num_batch):
    ...
    feat_test=feat_coding.get_vlad_feat(img_batch,grid_spacing,patch_size,bow_model)
